# -*- coding: utf-8 -*-
"""
Created on Fri Apr 30 14:38:50 2021

@author: ivand
"""

# =============================================================================
# 4. Compute de five-number summary, the mean, and the standard deviation for
# the annual salary and draw the boxplots for the 4 most common programming
# languages (the ones with more answers, you must compute the statistics for each
# one). Besides, answer the following questions by computing all the aditional 
# and necessary statistics and drawing the necessary graphs/plots.
# 
# =============================================================================
