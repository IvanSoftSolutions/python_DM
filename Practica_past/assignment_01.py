# -*- coding: utf-8 -*-
"""
Created on Fri Apr 30 14:38:26 2021

@author: ivand
"""

# =============================================================================
# 1. Compute de five-number summary, the mean, and the standard deviation for
# the annual salary per gender (the data considers three genders, you must compute
# the statistics for each one) and draw the boxplot. Besides, answr the following
# questions by computing all the aditional and necessary statistics and drawing
# the necessary graphs/plots.
# 
# =============================================================================
...
def gs_relation():
    f_gender_ManWoman = (df['Gender'].str.contains(r'Man') | df['Gender'].str.contains(r'Woman'))
    df[f_gender_ManWoman][['ConvertedComp']].plot(x='Gender', y='ConvertedComp', kind = 'scatter')
